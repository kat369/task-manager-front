...
function CreateProject() {
  ...
  const handlesubmit = async (e) => {
    ...
    try {
      let projectData = await axios.post('http://localhost:3100/createproject', data);
      console.log(projectData)
      if (projectData.status == 200) {
        navigate("/home/viewproject")
                  ...
                  <div className="card-body">
                    ...
                    <form onSubmit={handlesubmit}>
                      ...
                      <div class="text-center">
                        <button type="submit" onClick={focuschange} class="btn btn-primary">Create</button>&nbsp;
